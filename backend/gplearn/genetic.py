...
class BaseSymbolic(BaseEstimator, metaclass=ABCMeta):
    ...
    def fitCalc(self,population,user_fitness):
        ...
        for gen in range(prior_generations, self.generations):
            ...
            print(f'standard fitness evaluation for {gen} after normalization: {fitness}')
...
class SymbolicRegressor(BaseSymbolic, RegressorMixin):
    ...
    def __str__(self):
        ...
        return self.prefix_to_infix(self._program.__str__())
